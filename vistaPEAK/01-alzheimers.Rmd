...
## Mobile App Development (2013) {-#appdevelopment}
...
**"Mobile App Development and Usability Research to Help Dementia and Alzheimer Patients." Yamagata *et al.* *Institute of Electical and Electronics Engineers.* 2013.** [[.pdf]](https://drive.google.com/file/d/1pGXUdu3A0Jok5h5tK9oZ8kyQJt3UfqTC/view?usp=sharing)


```{r, echo=FALSE,out.width="80%",fig.align='center'}
myimages<-list.files("images/11/", pattern = ".png", full.names = TRUE)
...
## Universal Design (2015) {-#appdesign}
...
**"Universal Design with Mobile App Development: Bridging the Gap for the Forgotten Populations." Nezerwa *et al.* *Institute of Electical and Electronics Engineers.* 2015.** [[.pdf]](https://drive.google.com/file/d/1nrq_LxQMEAl3lfQ5ZwRqVE8Kixu8fJ-s/view?usp=sharing)


```{r, echo=FALSE,out.width="80%",fig.align='center'}
myimages<-list.files("images/12/", pattern = ".png", full.names = TRUE)
knitr::include_graphics(myimages)
```
...
## Mobile Reminders (2015) {-#reminders}
...
**"A Mobile Reminder System for Elderly and Alzheimer’s patients." Dalbouh *et al.* *International Journal of Computer Science Issues.* 2015.** [[.pdf]](https://drive.google.com/file/d/1gt3eoTwtONRQRUhJTGSizJWD6gHw1QU0/view?usp=sharing)

```{r, echo=FALSE,out.width="80%",fig.align='center'}
myimages<-list.files("images/14/", pattern = ".png", full.names = TRUE)
knitr::include_graphics(myimages)
```
...
## Protecting Cognition (2016) {-#cognition}
...
**"Protecting cognition from aging and Alzheimer’s disease: a computerized cognitive training combined with reminiscence therapy." Barban *et al.* *International Journal of Geriatric Psychiatry.* 2016.** [[.pdf]](https://drive.google.com/file/d/1tX0EJKxaMa_WLe3Phi50N96UBE3Lds_Q/view?usp=sharing)

```{r, echo=FALSE,out.width="80%",fig.align='center'}
myimages<-list.files("images/13/", pattern = ".png", full.names = TRUE)
knitr::include_graphics(myimages)
```
...
## Brain Plasticity (2017) {-#plasticity}
...
**"A Pilot Study on Brain Plasticity of Functional Connectivity Modulated by Cognitive Training in Mild Alzheimer’s Disease and Mild Cognitive Impairment." Barban *et al.* *Brain Sciences.* 2017.** [[.pdf]](https://drive.google.com/file/d/1F79-PBQmUwaGqHabexlMFK4EMWNwZZXk/view?usp=sharing)
...
## Promise of Technology (2018) {-#promise}
...
**"Seniors Living with Alzheimer's Disease and Dementia: The Promise of App Technology." Lu. *Major Papers.* 2018.** [[.pdf]](https://drive.google.com/file/d/1PNKD_PAxkFq1PB30dxGmB4O3CeLUMqCa/view?usp=sharing)
...
## Summary Recommendations {-#alzsum}
